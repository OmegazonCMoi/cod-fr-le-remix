...
const AdminPanel = () => {
    ...
    return (
        <div className="flex h-screen bg-neutral-100 overflow-x-hidden">
            {/* Sidebar */}
            <aside id="default-sidebar" className="top-0 left-0 z-40 w-64 h-screen transition-transform bg-neutral-50 fixed sm:translate-x-0">
                <h1 className="text-xl font-semibold text-neutral-800 bg-neutral-50 justify-center mx-auto flex items-center mt-5">Admin Dashboard</h1>
                <div className="h-full px-3 py-4 overflow-y-auto bg-neutral-50 dark:bg-gray-800">
                    <ul className="space-y-2 font-medium mt-2">
                        ...
                        <li onClick={() => setSelectedComponent('Files')}>
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
                        ...
                        <li onClick={() => setSelectedComponent('Users')}>
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
                        ...
                        <li onClick={() => setSelectedComponent('Games')}>
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
                        ...
                        <li onClick={() => setSelectedComponent('Videos')}>
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
                        ...
                        <li onClick={() => setSelectedComponent('Account')}>
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
                        ...
                        <li onClick={() => setSelectedComponent('Disconnect')}>
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
            ...
            {/* Main Content */}
            <main className="flex-1 ml-64"> {/* Add left margin to the main content to prevent it from being hidden behind the sidebar */}
                <Navbar />
