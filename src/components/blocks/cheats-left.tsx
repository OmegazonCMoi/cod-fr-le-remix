...
const CheatsLeft: React.FC<CheatsProps> = ({ id, title, description, video, link }) => {
            ...
            <div className="container">
                <div className="grid items-center gap-8 lg:grid-cols-2">
                    <video
                        ...
                        muted
                    />
                    <div className="cheats-text flex flex-col items-center text-end lg:items-end lg:text-right">
                        ...
                        <div className="flex w-full flex-col justify-center gap-2 sm:flex-row lg:justify-end opacity-0">
